...
PATH = '/content/drive/My Drive/Colab Notebooks/openSW_assign09/resnet50_epoch285.ckpt' # test acc would be almost 80
...
torch.save(model.state_dict(), '/content/drive/My Drive/Colab Notebooks/openSW_assign09/resnet50_final.ckpt')
