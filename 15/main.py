...
colab_path = "/content/drive/My Drive/Colab Notebooks/assign15"
...
data_dir = "/content/drive/My Drive/Colab Notebooks/assign15/dataset/VOCdevkit/VOC2012"
resize_size = 256
...
model.load_state_dict(torch.load(colab_path+ "/trained_model/UNet_trained_model.pth", map_location="cuda:0"))
...
result_save_dir = colab_path+'/history/result'+date+'/'
...
savepath1 = colab_path+"/output/model" + date + '/'
